...
<body>
    <header>
        <div class="header-box">
            ...
            <a href="./signup.php" class="menu-btn">新規登録</a>
        </div>
    </header>
    <main>
...
<?php } ?>
            <form class="login-form form" method="post">
                <input class="form-text" type="text" name="user_id" placeholder="ユーザーID">
                <input class="form-text" type="password" name="psword" placeholder="パスワード">
